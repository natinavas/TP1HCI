	...
	$.ajax(request).done(function(c){
		...
		for(i = 0; i < c.subcategories.length; i++){
			...
			$("#indumentaria").append('<div class="col-xs-2">'+
		                    ...
		                    '</div>'+
		                    '<a href="resultadosBusqueda.html?subcategory='+ c.subcategories[i].id +';gender=Mujeres;age=Adulto">'+
		                        '<div class="bw pic">'+
		...
		$("#indumentaria").append('<div class="col-xs-2">'+
		                    '<div class="row">'+
		                        '<div class=text-center>'+
		                            '<h3>Ver Todo</h3></div>'+
		                    '</div>'+
		                    '<a href="resultadosBusqueda.html?category=2;gender=Mujeres;age=Adulto">'+
		                        '<div class="bw pic">'+
		...
		$("#calzado").append('<div class="col-xs-2">'+
		                    '<div class="row">'+
		                        '<div class=text-center>'+
		                            '<h3>Ver Todo</h3></div>'+
		                    '</div>'+
		                    '<a href="resultadosBusqueda.html?category=1;gender=Mujeres;age=Adulto">'+
		                        '<div class="bw pic">'+
		...
		$("#accesorios").append('<div class="col-xs-2">'+
		                    '<div class="row">'+
		                        '<div class=text-center>'+
		                            '<h3>Ver Todo</h3></div>'+
		                    '</div>'+
		                    '<a href="resultadosBusqueda.html?category=3;gender=Mujeres;age=Adulto">'+
		                        '<div class="bw pic">'+
